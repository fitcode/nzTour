    ...
    module.directive('nzTour', function($q, $timeout, $window) {
        return {
            template: [
                ...
                '        <div id="nzTour-step">{{view.step + 1}} of</div>',
                ...
                '            <button id="nzTour-next" ng-show="view.step >= 0" ng-click="next()" class="btn-primary btn-small" class="ng-hide">{{view.nextText}}</button>',
                '        </div>',
                '    </div>',
                '</div>',
